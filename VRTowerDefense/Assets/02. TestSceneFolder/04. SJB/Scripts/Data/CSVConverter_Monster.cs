...
public class CSVConverter_Monster : MonoBehaviour
{
    private static CSVConverter_Monster converter_Instance;
    // 싱글턴으로 만들기
    public static CSVConverter_Monster Instance
    {
        get
        {
            if (converter_Instance == null)
            {
                converter_Instance = FindObjectOfType<CSVConverter_Monster>();
            }
